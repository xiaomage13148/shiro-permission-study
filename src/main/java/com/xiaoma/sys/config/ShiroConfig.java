package com.xiaoma.sys.config;

import com.xiaoma.sys.security.JWTFilter;
import com.xiaoma.sys.security.JwtRealm;
...
//        filterChainDefinitionMap.put("/productInfo/**", "roles[user]");
     ...
     */
    @Bean
    public DefaultWebSecurityManager defaultWebSecurityManager(JwtRealm jwtRealm, SubjectFactory subjectFactory,
